...
$resubmit = $_SERVER['PHP_SELF'] . "?" .  $_SERVER['QUERY_STRING'];

$g = new graph();
$g->js_path = "static/js/";
$g->set_swf_path("static/swf/");
...
<html>
    <head>
        <title><?=$title?></title>
        <link rel="stylesheet" rev="stylesheet" href="static/css/chart.css" type="text/css" media="screen"/>   
    </head>
    <body>
    <ul> 
        <li class="chart_bar">
